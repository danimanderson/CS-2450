...
This program requires a .txt file. You will be prompted for a file when you run the main.py. You will also be prompted for any inputs listed and separated by a comma.
