...
def test_multiply3():
    ...
    VM._memory = ["+5212", "+0000", "+3300", "+0000", "+4300"]
    VM._accumulator = "+5212"
    VM.run()
    assert(VM._accumulator == "+4944")
...
def test_divide():
    ...
    VM._memory = ["+0000", "+0002", "+3201", "+4300"]
    VM._accumulator = "+0050"
    VM.run()
...
def test_branch():
    ...
    VM._memory = ["+0000", "+0002", "+4004", "+4300", "+3201", "+4300"]
    VM._accumulator = "+0016"
    VM.run()
...
def test_branchzero2():
    VM = VirtualMachine()
    VM._memory = ["+4202", "+4300", "+3000", "+4300"]
    VM._accumulator = "+0000"
    VM.run()
    assert VM._accumulator == "+4202"
